...
function Simulator({ id }: { id: number }) {
  ...
  function update(attempt: LearningAttempt) {
    ...
    for (const key of ["learning", "learning-results", "dashboard", "wallet", "coin-progress", "badges", "notifications"]) void client.invalidateQueries({ queryKey: [key] });
  }
