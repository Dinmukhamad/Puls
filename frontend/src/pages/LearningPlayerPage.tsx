...
function AttemptPlayer({ id }: { id: number }) {
  ...
  return <div className="learning-player stack"><Link to="/training" className="learning-back">‹ Обучение</Link><header><Badge tone="accent">{attempt.content.kind === "test" ? "Проверка знаний" : attempt.content.world}</Badge><h1 className="page-title">{attempt.content.title}</h1></header>
